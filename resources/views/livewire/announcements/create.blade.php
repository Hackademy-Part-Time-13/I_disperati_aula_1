    ...
    <form class="mb-5" wire:submit.prevent="store">
        <div class="row">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select @error('category_id') is-invalid @enderror" wire:model.blur="category_id" required>
                            <p><option selected value="0">{{__('ui.seleziona')}}</option></p>
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn fw-semibold fs-6" style="background-color: #F3B61F">{{__('ui.crea_annuncio')}}</button>

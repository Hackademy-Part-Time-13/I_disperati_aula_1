        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area-login">
            ...
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #0D3B66;">
                <div class="featured-image mb-3">
                    ...
                    <p class="text-white fs-2 mt-3" style="font-weight: 700;">Unisciti a noi!</p>
                    <p class="text-white text-wrap text-center">Preparati per un'esperienza di acquisto memorabile.</p>
                </div>
            </div> 
                ...
                <div class="row align-items-center ms-2">
                    ...
                    <form action="/login" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <button type="submit" class="btn btn-lg w-100 fs-6 text-white" style="background-color: #0D3B66;">Accedi</button>
                        </div>

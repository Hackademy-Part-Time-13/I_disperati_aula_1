                    ...
                    <div class="card-profiles">
                        <div class="card-body-s">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="https://picsum.photos/400" alt="Admin" class="rounded-circle" width="150">
                                <div class="mt-3">
                    ...
                    <div class="card" style="width: 18rem;">
                        <div>
                            <img style="max-height:210px; object-fit:cover"
                                src="{{ !$like->announcement->images()->get()->isEmpty()? $like->announcement->images()->first()->getUrl(300, 300): 'https://picsum.photos/300/220' }}"
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-title "><a class="a-category text-black"
                                    href="{{ route('categories.show', $like->announcement->category) }}">{{ $like->announcement->category->name }}</a>
                            </p>

                            <p class="card-text">
                                {{ Illuminate\Support\Str::limit($like->announcement->description, 90) }}</p>
                            <div class="d-flex justify-content-between">
                                <p class="card-text"><em class="text-small">{{ $like->announcement->user->name }}</em>
                                </p>
                                <p class="card-text">
                                    {{ \Carbon\Carbon::parse($like->announcement->created_at)->format('d/m/Y') }}</p>
                            </div>
                            <p class="card-text text-end fw-semibold"><em>€
                                    {{ number_format($like->announcement->price, 2) }}</em></p>
                            @guest
                                <div class="text-center">
                                    <a href="{{ route('show.announcement', $like->announcement) }}" class="btn fs-6"
                                        style="background-color: #F3B61F">Visualizza annuncio</a>

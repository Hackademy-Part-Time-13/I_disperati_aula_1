...
class GoogleVisionSafeSearch implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $imageAnnotator = new ImageAnnotatorClient(); // apriamo collegamento con google vision
        $response = $imageAnnotator->safeSearchDetection($image);
        $imageAnnotator->close(); // chiudiamo collegamento con google vision

        $safe = $response->getSafeSearchAnnotation(); // recuperiamo le annotazioni
